...
namespace HU_HDP.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(HDPDbContext context)
        {
            _context = context;
        }
        ...
        {
            var hDPDbContext = _context.UserRoles.Include(u => u.Role).Include(u => u.User);
        ...
        public async Task<IActionResult> Create([Bind("UserRoleId,UserId,RoleId")] UserRole userRole)
        {
            ...
            ViewData["RoleId"] = new SelectList(_context.Set<Role>(), "RoleId", "RoleId", userRole.RoleId);
